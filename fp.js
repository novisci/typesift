...
const major = (a,b) => a.length > b.length ? a : b;
const minor = (a,b) => a.length > b.length ? b : a;
 ...
 * @param {*} b 
 */
const zip = (a) => (b) => major(a,b).map((x,i) => vector(2,[a[i],b[i]]));
 ...
 * @param {*} b 
 */
const zipr = (a) => (b) => major(a,b).map((x,i) => vector(2,[a[i%a.length],b[i%b.length]]));
